...
Backend for the diploma project "Development of a web service for reading graphic literature". Implemented as a **modular monolith** on Spring Boot 4 and Java 25.
...
Interactive documentation is available at: [`http://localhost:8080/scalar/index.html`](http://localhost:8080/scalar/index.html)
...
### Personal library - `/api/v1/library`
...
- **JDK 25** ([Eclipse Temurin](https://adoptium.net/) or any other distribution)
...
Dev profile is enabled by default. Spring Boot will automatically start the whole infrastructure via the
`spring-boot-docker-compose` dependency.

> **Environment variables setup**
>
> The environment variables file is located at the following path and already contains ready-to-use environment
> variables for a quick project start:
>
> ```
> src/main/docker/.env
> ```
